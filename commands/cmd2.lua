...
local function GetCommandModules()
	local success, result = pcall(function()
		return game:HttpGet("https://raw.githubusercontent.com/YourUserName/YourRepo/main/commands/index.json")
	end)
...
for _, cmdName in ipairs(GetCommandModules()) do
	local url = string.format("https://raw.githubusercontent.com/YourUserName/YourRepo/main/commands/%s.lua", cmdName)
